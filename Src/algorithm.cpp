 ...
 *
 *
 * - uint32_t getModuleCount() - возвращает количество модулей соединенных в одну цепочку (1..8)
 *
 *
...
{
	return 2; // Заменить на количество модулей собраных в одну цепочку. По умолчанию - 1.
}
