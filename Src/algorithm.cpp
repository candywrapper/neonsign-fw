 ...
 *		- rised(diIndex) - возвращает информацию о том что на цифровом входе с индексом diIndex (0..1) был восходящий фронт
 *		- fallen(diIndex) - возвращает информацию о том что на цифровом входе с индексом diIndex (0..1) был нисходящий фронт
 *
